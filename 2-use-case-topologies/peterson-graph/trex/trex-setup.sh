...
docker exec -it clab-trex-ubtrex03 ip addr add fc00:0:101:7::103/64 dev eth2
...
docker exec -it clab-trex-ubtrex04 ip addr add fc00:0:101:8::104/64 dev eth2
...
docker exec -it clab-trex-ubtrex05 ip addr add fc00:0:101:9::105/64 dev eth2
...
docker exec -it clab-trex-ubtrex06 ip addr add fc00:0:101:10::106/64 dev eth2
...
docker exec -it clab-trex-ubtrex07 ip addr add fc00:0:101:1::107/64 dev eth2
...
docker exec -it clab-trex-ubtrex08 ip addr add fc00:0:101:2::108/64 dev eth2
...
docker exec -it clab-trex-ubtrex09 ip addr add fc00:0:101:3::109/64 dev eth2
...
docker exec -it clab-trex-ubtrex10 ip addr add fc00:0:101:4::110/64 dev eth2
