...
docker exec -it clab-trex-ubtrex01 ip addr add 10.101.2.2/24 dev eth1
...
docker exec -it clab-trex-ubtrex01 ip addr add 10.101.3.2/24 dev eth1
...
docker exec -it clab-trex-ubtrex01 ip addr add 10.101.4.2/24 dev eth1
...
docker exec -it clab-trex-ubtrex01 ip addr add 10.101.5.2/24 dev eth1
...
docker exec -it clab-trex-ubtrex01 ip addr add 10.101.6.2/24 dev eth1
...
docker exec -it clab-trex-ubtrex01 ip addr add 10.101.7.2/24 dev eth1
...
docker exec -it clab-trex-ubtrex01 ip addr add 10.101.8.2/24 dev eth1
...
docker exec -it clab-trex-ubtrex01 ip addr add 10.101.9.2/24 dev eth1
...
docker exec -it clab-trex-ubtrex01 ip addr add 10.101.10.2/24 dev eth1
